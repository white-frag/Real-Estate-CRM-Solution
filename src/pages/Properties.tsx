  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative">
              ...
              <div className="absolute top-2 right-2 flex space-x-1">
                ...
                <button
                  ...
                  title="Edit Property"
                >
                  <Edit className="h-4 w-4 text-midnight-blue" />
                </button>
                <button
        ...
        <div 
          onClick={() => setShowAddForm(true)}
          className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-midnight-blue hover:bg-blue-50 transition-colors cursor-pointer flex flex-col items-center justify-center min-h-[400px]"
        >
          <Plus className="h-12 w-12 text-gray-400 mb-4" />
          <h3 className="text-lg font-medium text-gray-600 mb-2">Add New Property</h3>
          <p className="text-sm text-gray-500 text-center">Click here to add a new property to your listings</p>
        </div>
      </div>
