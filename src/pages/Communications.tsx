  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">Send WhatsApp messages, emails, and SMS to your leads</p>
      </div>
          ...
          <div className="p-6 space-y-4">
            ...
            {selectedLeadData && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-medium text-blue-900">{selectedLeadData.name}</h4>
            ...
            <button
              ...
              className="flex items-center space-x-2 bg-midnight-blue text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              {isSending ? (
                <>
        ...
        <div className="p-6">
          {leads.some(lead => lead.communicationHistory.length > 0) ? (
            ...
            <div className="text-center text-gray-500 py-8">
              ...
              <p className="text-sm">Start sending messages to see your communication history here</p>
            </div>
          )}
        </div>
      </div>
